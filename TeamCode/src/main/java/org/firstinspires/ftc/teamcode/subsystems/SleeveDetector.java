...
/*
This code is from last year's sleeve detector.
Notably, it uses OpenFTC's EOCV and AprilTag.


Do we use this same system? Possibly.

Technically, VisionPortal uses EOCV behind the scenes, just simplifies the code.
It's also been said that TFOD is uncannily good at accurate location detection for AprilTags, which
would be more important this year than it was last year.
