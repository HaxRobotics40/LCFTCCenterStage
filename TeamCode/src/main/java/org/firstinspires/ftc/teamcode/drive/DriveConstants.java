...
=======
    ...
    public static double GEAR_RATIO = 1.31; // output (wheel) speed / input (motor) speed
...
>>>>>>> Stashed changes
     ...
     * inches.
     */
    public static double MAX_VEL = 48.9;
    public static double MAX_ACCEL = 30;
    public static double MAX_ANG_VEL = Math.toRadians(136.2);
